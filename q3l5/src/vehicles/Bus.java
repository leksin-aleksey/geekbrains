...
public class Bus extends Vehicle{
    private static final float TANK_CAPACITY_DEFAULT = 40f;
    private static final float MPG_DEFAULT = 7.5f;
    ...
    public Bus(String registrationPlate, float tankCapacity, float mpg) {
        this.registrationPlate = registrationPlate;
